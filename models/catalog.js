...
module.exports.declineStatusForCatalog = function (id,callback) {
    catalog.findOne({_id : id},function (err,catalog) {
        console.log(catalog);
...
module.exports.approveStatusForCatalog = function (id,cost,callback) {
    catalog.findOne({_id : id},function (err,catalog) {
        console.log(catalog);
